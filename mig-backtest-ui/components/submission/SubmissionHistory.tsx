        ...
        <tbody>
          {submissions.map((sub, i) => {
            ...
            return (
              ...
              >
                <td className="px-4 py-3.5 mono-nums text-slate-600 text-xs">#{i + 1}</td>
                ...
                <td className="px-4 py-3.5 text-right">
                  {sharpe !== null ? (
                    <span className={`mono-nums font-semibold text-sm ${sharpe >= 1 ? "text-emerald-400" : sharpe >= 0 ? "text-slate-300" : "text-rose-400"}`}>
                      {sharpe.toFixed(2)}
                    </span>
                  ) : (
                ...
                <td className="px-4 py-3.5 text-right hidden md:table-cell">
                  {pnl !== null ? (
                    <span className={`mono-nums text-sm ${pnl >= 0 ? "text-emerald-400" : "text-rose-400"}`}>
                ...
                <td className="px-4 py-3.5 text-right hidden md:table-cell">
                  {maxDrawdown !== null ? (
                    <span className={`mono-nums text-sm text-slate-300`}>

...
function CodeBlock({ code, lang = "python" }: { code: string; lang?: string }) {
  ...
  return (
    <div className="relative group rounded-xl overflow-hidden border border-slate-800 bg-slate-900/80">
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex gap-10">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-10">
          {/* Header */}
          <div>
            <p className="text-emerald-400 text-xs font-mono uppercase tracking-widest mb-2">Developer Docs</p>
            <h1 className="text-3xl sm:text-4xl font-bold text-slate-100 mb-3">Documentation</h1>
          ...
          <Section id="quickstart">
            <div className="glass-card rounded-2xl p-6 md:p-8">
              <h2 className="text-slate-100 font-bold text-xl mb-2">Quick Start</h2>
              ...
              <ol className="flex flex-col gap-6">
                {[
                  ...
                  <li key={step} className="flex gap-4">
                    <span className="font-mono text-2xl font-bold text-slate-700 shrink-0 w-8">{step}</span>
                    <div>
          ...
          <Section id="strategy-interface">
            <div className="glass-card rounded-2xl p-6 md:p-8">
              <h2 className="text-slate-100 font-bold text-xl mb-2">Strategy Interface</h2>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                {[
                  ...
                  <div key={tag} className={`rounded-xl p-4 border-l-4 ${color}`}>
                    ...
                    <p className="text-slate-200 font-semibold font-mono mt-1">
                      {name}{" "}
                ...
                {[
                  ...
                  <div key={col} className="bg-slate-900/50 rounded-xl p-4 border border-slate-800">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-slate-200 font-mono font-semibold text-sm">{col}</span>
          ...
          <Section id="submission-format">
            <div className="glass-card rounded-2xl p-6 md:p-8">
              <h2 className="text-slate-100 font-bold text-xl mb-2">Submission Format</h2>
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div className="bg-slate-900/50 rounded-xl p-5 border border-slate-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="text-slate-200 font-semibold text-sm">Single Python file</p>
                  </div>
                  <p className="text-slate-500 text-sm leading-relaxed mb-3">
                    Upload a single <code className="font-mono text-slate-300">.py</code> file that imports only packages from the allowed
                    list and defines <code className="font-mono text-slate-300">get_actions</code>.
                  </p>
                  <p className="text-slate-600 text-xs">Max size: 1 MB</p>
                </div>
                <div className="bg-slate-900/50 rounded-xl p-5 border border-slate-800">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="text-slate-200 font-semibold text-sm">Zip bundle</p>
                  </div>
                  <p className="text-slate-500 text-sm leading-relaxed mb-3">
                    ...
                    <code className="font-mono text-slate-300">.pkl,.joblib,.npy,.npz</code> in the zip.
                  </p>
                  <p className="text-slate-600 text-xs">Max size: 10 MB</p>
                </div>
              </div>
              <div className="mt-5">
          ...
          <Section id="packages">
            <div className="glass-card rounded-2xl p-6 md:p-8">
              <h2 className="text-slate-100 font-bold text-xl mb-2">Available Packages</h2>
              <p className="text-slate-400 text-sm mb-5 leading-relaxed">
                These packages are pre-installed in the sandbox and available in every submission without a{" "}
                <code className="font-mono text-slate-300">requirements.txt</code>.
              </p>
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
                {[
                  ...
                  <div key={pkg} className="bg-slate-900/60 rounded-xl p-3 border border-slate-800">
          ...
          <Section id="backtester">
            <div className="glass-card rounded-2xl p-6 md:p-8">
              <h2 className="text-slate-100 font-bold text-xl mb-2">Backtester Mechanics</h2>
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">
              ...
              <div className="mt-4 rounded-xl bg-rose-500/5 border border-rose-500/20 p-4">
                ...
                <ul className="text-slate-400 text-sm leading-relaxed space-y-1 list-disc list-inside">
                  ...
                  <li>
                    <code className="font-mono text-slate-300">get_actions</code> raises an unhandled exception.
                  </li>
          ...
          <Section id="scoring">
            <div className="glass-card rounded-2xl p-6 md:p-8">
              <h2 className="text-slate-100 font-bold text-xl mb-6">Scoring</h2>
              ...
              <div className="mt-5 rounded-xl bg-violet-500/5 border border-violet-500/20 p-4">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  ...
                  <span className="text-slate-200 font-medium">out-of-sample hidden test set</span>. The same strategy code is evaluated
          ...
          <Section id="constraints">
            <div className="glass-card rounded-2xl p-6 md:p-8">
              <h2 className="text-slate-100 font-bold text-xl mb-5">Constraints</h2>
          ...
          <Section id="sample">
            <div className="glass-card rounded-2xl p-6 md:p-8">
              <h2 className="text-slate-100 font-bold text-xl mb-2">Sample Repo</h2>
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={file} className="bg-slate-900/50 rounded-xl p-4 border border-slate-800 flex gap-3">
                    <span className={`text-xs font-mono px-2 py-0.5 h-fit rounded-full border ${tagColor} shrink-0`}>{tag}</span>
                    <div>
                      <p className="text-slate-200 font-mono font-semibold text-sm mb-1">{file}</p>
                      <p className="text-slate-500 text-xs leading-relaxed">{desc}</p>
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-6 flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-800 border border-slate-700 text-slate-200 text-sm font-medium hover:bg-slate-700 hover:border-slate-600 transition-colors"
                >
              ...
              <div className="mt-4 rounded-xl bg-slate-900/50 border border-slate-800 p-4">
